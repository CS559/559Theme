/*
 * MiniSearch v7.2.0 (UMD build) — vendored from the official npm package.
 * https://github.com/lucaong/minisearch — MIT License, Copyright 2022 Luca Ongaro.
 * Source: https://cdn.jsdelivr.net/npm/minisearch@7.2.0/dist/umd/index.js
 * Note: as of 7.x the package ships this UMD bundle unminified (no dist/umd/index.min.js);
 * `resources.Minify` compresses it at Hugo build time (see _partials/head/search-scripts.html or layouts/search.html).
 */
