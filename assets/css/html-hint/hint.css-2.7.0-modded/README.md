# Hint.css - Gleicher's Version

A version hacked by Gleicher so it can be built with html-hints.

Basically, I...
- stripped out the npm/grunt build stuff (since I wasn't using it)
- modernized the scss files so they compile with the version of sass I use, without deprecation warnings
- put it in a convenient place so I don't have to deal with npm issues
