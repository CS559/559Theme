...
workspace's four sites, so "zero usage here" is a soft-retire candidate to
...
def main():
    ...
    out.append("Generated by `tools/usage-matrix.py`. Read-only information map, "
               "**not a delete list** — 559Theme has consumers outside these four "
               ...
               "Columns are the four consumer sites; numbers are literal "
